...
Решения, использующие случайные числа, получат 1
 балл.

Решения без использования случайных чисел получат 2
 балла.

Входные данные
В первой строке дается число n
 (1≤n≤105)
- количество элементов в массиве, затем даются n
 чисел (0≤ai≤109)
.
